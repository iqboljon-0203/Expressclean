...
export function MobileStickyBar({ phone = "+998 95 009 48 59" }: { phone?: string }) {
    ...
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-muted shadow-[0_-4px_12px_rgba(0,0,0,0.05)] pb-safe-area">
      <div className="flex p-3 gap-2">
        <button
          ...
          className="flex-1 bg-primary text-white rounded-xl py-3.5 flex items-center justify-center font-bold text-[15px] active:scale-[0.98] transition-transform shadow-premium"
        >
